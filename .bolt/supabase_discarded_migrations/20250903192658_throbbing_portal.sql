/*
  ...
  1. Changes
    - Add transaction_hash column to payments table for crypto payment tracking
...
CREATE INDEX IF NOT EXISTS idx_payments_transaction_hash_crypto ON public.payments(transaction_hash) WHERE transaction_hash IS NOT NULL;